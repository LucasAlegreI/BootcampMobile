class Poker {
    ...
    var gameType2:(Int,[Int])?=nil
    func main() ->Int{
        hand1 = generateHand()
        hand2 = generateHand()
        gameType1 = checkGames(cards: hand1)
        gameType2 = checkGames(cards: hand2)
        return findBetter(values1: gameType1!, values2: gameType2!)
    }
    ...
    func findBetter(values1: (Int, [Int]), values2: (Int, [Int])) -> Int {
        if values1.0 != values2.0 {
            return values1.0 < values2.0 ? 0 : 1
        }
